...
public class PathingTask
{
    ...
    public static PathingTask? BuildFromFilePath(string filePath)
    {
        ...
        {
            TaskControl.Logger.LogWarning("地图追踪任务 {Name} 版本号要求 {BgiVersion} 大于当前 BetterGI 版本号 {CurrentVersion} ，可能会有兼容性問題！", task.FileName, task.Info.BgiVersion, Global.Version);
        }
        return task;
    }
